                ...
                <form id="FormCB" method="post" action="BDD_paiement.php">
                    <div id="Entree">
                        <div id="Partie1">
                            ...
                            <input id="Titulaire" class="Champs" name="Titulaire" min="0" max="24" type="text" pattern="[A-Za-z\s]*" required>
                        </div>
                        <div id="Partie2">
                            ...
                            <input pattern="[0-9]*" id="CVV" class="Champs" name="CVV" type="text" maxlength="3" required>
                        </div>
