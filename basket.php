    ...
    AND id_coach > 'A2'";
        ...
        <div class="text_coach">
            ...
            <p class="description_coach">
                Vous souhaitez vivre <span class="highlight">une expérience unique et passionnante</span> dans le monde
                du basket-ball ? Je serai le
                ...
                qu'un enseignant : je suis votre mentor, votre motivation et <span class="highlight">votre guide vers
                    l'excellence</span>.<br><br> Prêt à vous
                transmettre les fondamentaux techniques, les stratégies gagnantes et l'esprit d'équipe, je sais comment
                stimuler votre potentiel et <span class="highlight">vous faire briller sur le terrain</span>.</br></br>
                Rejoignez mes cours et laissez-vous
                emporter par mon énergie contagieuse, ma pédagogie personnalisée et ma détermination à vous voir
                réussir. Ne manquez pas l'occasion de vous épanouir dans le basket-ball et de <span
                    class="highlight">vous surpasser a mes côtés</span>,
